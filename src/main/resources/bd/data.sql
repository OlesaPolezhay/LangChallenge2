...
VALUES
    ...
    ('Подумай над значенням, перед тим як натискати на відповідь','CAACAgIAAxkBAAEFDt5mLqkMQChZlP_jdb7nm8EHWF6N_QACxE8AAlzreUmrmyQY_BtQFTQE','die Sonnenbrille','die Sonnebrille','die Brillesonne','die Brillensonne',  1, 3),
...
"Es ist Zeit, ___ zu gehen, wir sind schon spät dran."
"Leider muss ich jetzt ___ , der Zug fährt gleich ab."', 'CAACAgIAAxkBAAEFEN9mL3UDcOWP0A_z0g9IW_4O9iePxgACpgADUomRI2u5KhCNt8e8NAQ',  'los/weg, los/weg', 'los, weg', ' weg, los', 'os, los', 2, 2),
    ('Вставте пропущені слова ("weg" або "los") у речення:

"Alles ist ___ , wir können nichts mehr tun."
"Mein Portemonnaie ist ___, ich finde es nirgendwo."', 'CAACAgIAAxkBAAEFESFmL3wy2Qm6-4HzjO7A_v5RW8-mgAACqgADUomRI_EQwwMdkDzvNAQ',  'weg, weg', 'weg, los', 'los, weg', 'los, los', 2, 3);